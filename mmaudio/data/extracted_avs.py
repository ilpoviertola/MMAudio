...
class ExtractedAVS(Dataset):
    ...
    def __init__(
        ...
        *,
        ...
        if local_rank == 0:
            ...
            log.info(f"Loaded mask_video: {self.mask_video.shape}.")
        ...
        assert (
            self.sync_features.shape[1] == self.data_dim["sync_seq_len"]
        ...
        assert (
            self.sync_features.shape[-1] == self.data_dim["sync_dim"]
    ...
    def __getitem__(self, idx: int) -> dict[str, torch.Tensor]:
        data = {
            ...
            "mask_video": self.mask_video[idx],
