...
class VGGSound(Dataset):
    ...
    def __init__(
        ...
        *,
        ...
        masks = sorted(os.listdir(self.mask_root))
        masks = set([Path(v).stem for v in masks])

        videos = videos.intersection(masks)
        self.labels = {}
        self.videos = []
        missing_videos = []
    ...
    def sample(self, idx: int) -> dict[str, torch.Tensor]:
        ...
        mask_chunk = self.get_extended_masks(self.mask_root / video_id)[
            : int(self.duration_sec * _MASK_FPS)
        ]
...
if __name__ == "__main__":
    ds = VGGSound(
        ...
        tsv_path="/home/ilpo/repos/MMAudio/sets/vgg3-train.tsv",
        sample_rate=44100,
        duration_sec=5.0,
        normalize_audio=False,
        audio_samples=221184,
    )
